      ...
      {cart.length !== 0 ? (
        <div className="w-9/12 my-16">
          ...
          <div className="w-9/12 mt-16">
            <p className="text-lg">
              Subtotal: <span className="text-xl text-orange-600">{total}</span>{" "}
              $
            </p>
            ...
            <div className="flex gap-4 mt-4">
              <button className="border border-orange-600 bg-orange-600 text-white py-1 px-4 rounded-md">
    ...
    <>
      {cart.map((product) => (
        <div className="flex w-full ">
          ...
          <div className="w-2/12 border flex justify-center items-center py-2">
            <p
              className="text-sm md:text-lg text-red-700"
